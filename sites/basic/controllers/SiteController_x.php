...
class SiteController extends Controller
{
    ...
    protected function get_taskexpenses777($date_from, $date_to,  $status){
    ...
    public function actionReport()
    {
          ...
          if(  $req->get('date_from')  && $req->get('date_to') ){
                ...
                $data_str = $req->get('date_from')." --  ".$req->get('date_to');
          	    ...
          	    $NewArr = $this->get_taskexpenses777($from, $to, [30]);
	                ...
	                elseif( $req->get('report') && $req->get('report') == 2){
	                	    ...
	                	    $NewArr5 = $this->ArrayGroupBy($NewArr,'Участок__', 'Д.Code');
	                       // $NewArr5 = $this->Group_by('Д.Code', $NewArr);
